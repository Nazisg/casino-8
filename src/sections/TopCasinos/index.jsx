...
export default function TopCasinos() {
    return (
        <section id="top-casinos" className="min-h-screen py-10 px-4">
            <h2 className="text-[24px] lg:text-[48px] font-bold glow-text text-center">Top Rated Online Casinos</h2>
            <p className="text-[#D1D5DB] text-[16px] lg:text-[20px] text-center">Handpicked selection of the best online casinos with exclusive bonuses and verified reviews</p>
